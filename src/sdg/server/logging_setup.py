...
LOGGING_PATH = os.path.join(importlib_resources.files(__package__.split(".")[0]), "logs")
...
def setup_root_logger():
    ...
    file = RotatingFileHandler(filename=os.path.join(LOGGING_PATH, "fastapi-sdg-logs.log"), mode='a', maxBytes=15000000, backupCount=5)
